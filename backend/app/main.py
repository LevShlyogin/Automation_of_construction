...
from backend.app.models import Turbine  # Предполагая, что у вас есть модель Turbine
from backend.app.schemas import TurbineInfo  # Схема для сериализации TurbineInfo
from backend.app.dependencies import get_db  # Зависимость для получения сессии БД
from backend.app.core.config import settings  # Настройки приложения
...
# Подключаем маршруты к основному приложению с необходимым префиксом
